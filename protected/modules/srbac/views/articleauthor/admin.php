<?php
/* @var $this ArticleauthorController */
/* @var $model ArticleAuthor */

$this->breadcrumbs=array(
	'Article Authors'=>array('index'),
	'管理',
);
...
$('.search-form form').submit(function(){
	$('#article-author-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<script type="text/javascript">
    ...
    var deleteAll = function (){
        ...
        if(data.length > 0){
            $.post('http://www.xiaozhi.com/srbac/article-author/delall',{'selectdel[]':data}, function (data) {
            	var json = eval('(' + data + ')'); 
        	    if(json.statu == 0){

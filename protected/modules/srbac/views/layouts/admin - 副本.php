...
<?php
    Yii::app()->clientScript->registerScriptFile($this->module->assetUrl.'/css/common.js');
    Yii::app()->clientScript->registerScriptFile('/js/ymPrompt/ymPrompt.js');
    Yii::app()->clientScript->registerCssFile('/js/ymPrompt/skin/qq/ymPrompt.css');
?>
</head>
<?php
	...
	$(document).ready(function(){
		...
		$(".nav13 a").click(
			...
			function(){
                ...
                var lin=$(".left1 a:first-child");
                var url=lin.attr('href');
...
<body>
	<div class="left fl">
    	<div class="logo height1">
        	<?php $site= Yii::app()->controller->module->getComponent('user')->site_id;
            $config =Config::model()->find('site_id=:site_id',array(':site_id'=>$site));
            if(empty($config)){?>
                <a href="/"><img src="<?php echo $this->module->assetUrl; ?>/images/login/logo.jpg" /></a>
            <?php } else {?>
                <a href="/"><img src="/upload/logo_file/small/<?php echo $config->site_logo;?>" /></a>
            <?php } ?>
        </div>
        <div class="left1">
    ...
    <div class="right fl">
    	<div class="nav1 height1">
        	<div class="nav11">
                ...
                <div class="nav14 fr">您好，<b><?php echo Yii::app()->controller->module->getComponent('user')->name; ?> </b><a href="/srbac/gerenziliao/admin">[个人资料修改]</a> <a href="<?php echo $this->createUrl('/srbac/default/logout'); ?>">[退出]</a> <!-- <a href="/" target="_blank">站点首页</a> --></div>
            </div>
            <div class="widthie7">
                <div class="nav12">

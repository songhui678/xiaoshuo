    ...
    'components' => array(
        ...
        'urlManager'   => array(
            ...
            'rules'          => array(
                ...
                '<pinyin:\w+>/<id:\d+>'                  => array('show/index', 'urlSuffix' => '.html'),
                '<pinyin:\w+>/page-<page:\d+>'           => array('list/index', 'urlSuffix' => '/'),
                '<pinyin:\w+>/'                          => array('list/index', 'urlSuffix' => '/'),

                // 'http://www.jieshuolol.com' => 'list/2',

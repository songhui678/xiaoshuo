...
<script type="text/javascript">BAIDU_CLB_fillSlot("1041451");</script>
</div>
...
<div class="box">
    ...
    <div class="index_middle_title">
        <h1><a href="<?php echo $this->createUrl('list/index', array('pinyin' => $cate->pinyin)); ?>"><?php echo $cate->title; ?>解说lol视频</a></h1>
    <h4>
        <a href="<?php echo $this->createUrl('list/index', array('pinyin' => $cate->pinyin)); ?>" target="_blank"><?php echo $cate->title; ?>最新视频</a>

    </h4>
        <h3>
            <ul>
            <a href="<?php echo $this->createUrl('list/index', array('pinyin' => $cate->pinyin)); ?>"><li id="gdg1" onmouseover="setTab('gdg',1,2);" class="h3on"><?php echo $cate->title; ?>最新解说lol视频</li></a>
    <a href="<?php echo $this->createUrl('list/index', array('pinyin' => $cate->pinyin)); ?>" target="_blank"><li id="gdg2" onmouseover="setTab('gdg',2,2);">解说lol视频</li></a>
            </ul>
        </h3>
    </div>
     ...
     <?php foreach ($articleList as $key => $article) {?>
        <li>
            ...
            <a href="<?php echo Yii::app()->createUrl('show/index', array('id' => $article->ArticleOne->id, 'pinyin' => $article->CateOne->pinyin)); ?>" target="_blank">
                ...
                <a href="<?php echo Yii::app()->createUrl('show/index', array('id' => $article->ArticleOne->id, 'pinyin' => $article->CateOne->pinyin)); ?>" target="_blank"><?php echo Helper::truncate_utf8_string($article->ArticleOne->title, 17, '...'); ?></a>
